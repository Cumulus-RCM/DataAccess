...
public sealed record Operator : Enumeration {
    ...
    public static readonly Operator In = new(9, "IN") {PreTemplate = "(", PostTemplate = ")", IsTemplateWrappedInQuotes = false};
    ...
    [JsonIgnore] public bool IsTemplateWrappedInQuotes { get; init; } = true;
