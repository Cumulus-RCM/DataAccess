...
public sealed class Operator : Enumeration {
    ...
    public static readonly Operator StartsWith = new Operator(7, "like") {PostTemplate = "%"};
    public static readonly Operator Contains = new Operator(8, "like") {PreTemplate = "%", PostTemplate = "%"};
